...
Este código implementa un chatbot inteligente que combina:
- RAG (Retrieval Augmented Generation): Búsqueda en documentos propios
- Procesamiento multimodal: Manejo de texto e imágenes
- LangGraph: Framework para crear flujos de conversación complejos
- Panel: Interfaz web interactiva

CARACTERÍSTICAS PRINCIPALES:
Sube documentos (PDF, CSV, Excel) para consultas RAG
Analiza imágenes con IA (JPG, PNG, GIF, BMP, WebP) 
Dos modelos LLM especializados (texto vs imágenes)
Memoria de conversación persistente
Flujo inteligente que decide qué modelo usar
Interfaz web fácil de usar

FLUJO DEL CHATBOT:
1. Usuario hace pregunta (con o sin imagen)
2. Sistema decide si es pregunta trivial o compleja
3. Si es compleja: busca en documentos (RAG)
4. Selecciona modelo apropiado (texto o imagen)
